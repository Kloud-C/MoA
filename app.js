(() => {
  ...
  if (mbtiForm) {
    ...
    const typeProfiles = {
      ...
      ESTP: { title: "일단 해보는 현장 플레이어", image: "image/MBTI image/MBTI：ESTP.jpg", intro: "상황을 빠르게 읽고 망설이기보다 직접 움직이며 답을 찾는 에너지 넘치는 사람이에요.", daily: "‘언젠가 해보자’보다 ‘이번 주에 가볼까?’가 익숙해요. 즉흥적인 계획에서 좋은 이야기가 시작되곤 해요.", love: "함께 웃고 움직이는 데이트를 즐겨요. 솔직하고 생생한 표현이 매력 포인트예요.", work: "현장에서 필요한 걸 바로 파악하고 빠르게 대응해요. 변화가 많은 환경에서 존재감이 커져요." },
      ESFP: { title: "분위기를 밝히는 순간 수집가", image: "image/MBTI image/MBTI：ESFP.jpg", intro: "사람과 즐거움이 있는 곳에서 반짝이는, 지금을 신나게 살아내는 타입이에요.", daily: "좋은 일이 있으면 같이 나눌 사람부터 떠올려요. 맛있는 것과 재미있는 경험은 혼자보다 함께일 때 더 좋아요.", love: "좋아하는 마음을 숨기기보다 다정하게 표현해요. 함께 웃었던 순간을 둘만의 추억으로 잘 간직합니다.", work: "사람들과 호흡을 맞추고 지루한 분위기에 활기를 더해요. 직접 해보고 반응을 나눌 때 실력이 나와요." },
      ENFP: { title: "가능성을 줍는 아이디어 메이커", image: "image/MBTI image/MBTI：ENFP.jpg", intro: "사람과 아이디어 사이의 연결을 발견하면 눈이 반짝이는 호기심 많은 낙관주의자예요.", daily: "새로운 관심사가 생기면 관련 영상과 장소를 한꺼번에 찾아봐요. 친구에게 ‘우리 이거 해보자!’고 먼저 제안하기도 해요.", love: "서로의 꿈을 응원하고 진심을 자주 표현하는 관계를 좋아해요. 함께 새로운 경험을 만드는 데 설렙니다.", work: "브레인스토밍과 협업에서 에너지를 얻어요. 흩어진 아이디어를 이어 가능성 있는 출발점으로 만드는 재주가 있어요." },
      ENTP: { title: "토론을 놀이처럼 즐기는 발명가", image: "image/MBTI image/MBTI：ENTP.jpg", intro: "익숙한 답에도 물음표를 붙이고, 생각의 빈틈에서 새로운 가능성을 발견해요.", daily: "재미있는 논쟁은 이기기 위해서라기보다 생각을 넓히는 놀이터예요. 같은 길보다 새로운 루트를 궁리해요.", love: "재치 있는 대화와 서로 자극을 주는 관계에 끌려요. 장난스러운 티키타카 속에 관심을 표현합니다.", work: "막힌 문제를 다른 각도에서 보고 대안을 쏟아내요. 반복 업무보다 변화와 실험이 있는 과제에서 신나요." },
