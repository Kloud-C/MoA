...
window.MOA_ARCHETYPE_TESTS["spending-habits"] = {
  ...
  profiles: {
    frugal: {
      ...
      details: [
        { title: "잘하는 점 🌿", text: "지출을 살펴보고 더 나은 선택을 찾는 힘이 있어요. 계획적으로 모은 여유 자금은 예상하지 못한 상황이나 중요한 목표에 도움이 됩니다." },
        { title: "작은 균형 팁 💡", text: "아끼는 일만큼 지금의 만족도 소중해요. 꼭 필요한 즐거움에는 미리 작은 예산을 정해 두면 절약과 경험을 함께 챙길 수 있어요." }
      ]
    },
    flex: {
      ...
      details: [
        { title: "잘하는 점 🌟", text: "무엇이 나에게 기쁨과 가치를 주는지 잘 알아요. 만족도 높은 경험에 집중하면 소비가 좋은 추억과 동기가 될 수 있습니다." },
        { title: "작은 균형 팁 💡", text: "큰 지출을 하기 전에 이번 달 여유 금액을 확인해 보세요. 즐거움을 위한 예산을 먼저 정하면 마음 편하게 경험을 누릴 수 있어요." }
      ]
    },
    planned: {
      ...
      details: [
        { title: "잘하는 점 🧭", text: "무엇을 위해 돈을 쓰는지 분명하게 알고 있어요. 예산을 나눠 관리하면 목표에 필요한 준비를 꾸준히 이어갈 수 있습니다." },
        { title: "작은 균형 팁 💡", text: "계획은 상황에 따라 조금 바뀌어도 괜찮아요. 즐거운 즉흥 지출을 위한 여유 항목을 두면 계획을 지키면서 유연함도 얻을 수 있어요." }
      ]
    },
    impulse: {
      ...
      details: [
        { title: "잘하는 점 🎉", text: "좋아하는 것을 발견하고 바로 즐기는 추진력이 있어요. 새로운 경험을 시작하는 데 망설임이 적고, 순간의 기쁨을 잘 알아차립니다." },
        { title: "작은 균형 팁 💡", text: "큰 금액은 장바구니에 담아 하루 뒤 다시 확인해 보세요. 월간 자유 예산을 정해 두면 즉흥적인 즐거움도 부담을 줄이며 이어갈 수 있어요." }
      ]
    }
  }
};
