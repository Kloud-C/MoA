...
window.MOA_ARCHETYPE_TESTS["attachment-style"] = {
  ...
  profiles: {
    secure: {
      ...
      details: [
        { title: "연애할 때 💌", text: "애정과 고마움을 자연스럽게 표현해요. 갈등이 있어도 관계를 단정하기보다 함께 풀 방법을 찾습니다." },
        { title: "인간관계에서 🌿", text: "친밀함과 각자의 생활을 균형 있게 이어가요. 부탁하거나 도움을 받는 일을 관계의 일부로 여겨요." },
    ...
    avoidant: {
      ...
      details: [
        { title: "연애할 때 💌", text: "마음이 있어도 표현을 서두르지 않을 수 있어요. 부담을 느끼면 잠시 거리를 두고 차분해진 뒤 이야기하는 편입니다." },
        { title: "인간관계에서 🌿", text: "스스로 해결하는 데 익숙하고 사적인 시간을 소중히 여겨요. 상대에게 필요한 거리를 말로 알려주면 오해를 줄일 수 있어요." },
    ...
    anxious: {
      ...
      details: [
        { title: "연애할 때 💌", text: "애정 표현과 꾸준한 연락에서 안정감을 느껴요. 걱정이 커질 때는 추측을 키우기보다 원하는 연락이나 표현을 구체적으로 말해보세요." },
        { title: "인간관계에서 🌿", text: "친구의 기분과 관계의 온도를 세심하게 살펴요. 상대의 모든 반응을 혼자 책임질 필요는 없다는 점도 기억해 주세요." },
    ...
    fearful: {
      ...
      details: [
        { title: "연애할 때 💌", text: "상대가 다가오면 반갑다가도 부담스럽고, 거리가 생기면 다시 가까워지고 싶을 수 있어요. 내게 편안한 속도를 알아가는 게 도움이 됩니다." },
        { title: "인간관계에서 🌿", text: "관계의 작은 변화도 크게 느껴질 수 있어요. 안전하다고 느끼는 사람과 천천히 신뢰를 쌓아가도 괜찮아요." },
        { title: "잘 맞는 대화 🗣️", text: "마음을 열 준비가 되는 속도를 존중하고, 약속과 경계를 차분히 확인할 수 있는 대화가 편안함을 줘요." }
      ]
    }
  }
};
